...
SCENARIOS=(
    ...
    "S3_RSA_Medium_50pct"
    "S3_RSA_Medium_60pct"
    "S4_ECDSA_Medium_8pct"
    "S4_ECDSA_Medium_15pct"
    "S4_ECDSA_Medium_30pct"
    "S4_ECDSA_Medium_40pct"
    "S4_ECDSA_Medium_50pct"
    "S4_ECDSA_Medium_60pct"
    "S5_RSA_NoAttack_Medium"
    "S6_ECDSA_NoAttack_Medium"
)
...
run_one() {
    ...
    opp_run "${OPP_ARGS[@]}" -c "$scenario" -r "$r" omnetpp_medium.ini \
...
if [ -f "$RESULTS_DIR/.sim_error" ]; then
    ...
    METRICS_FILE="$RESULTS_DIR/metriche_replay_medium.txt"

    echo "================================================================" > "$METRICS_FILE"
    echo "METRICHE COMPLETE — Replay Attack — Medium Topology" >> "$METRICS_FILE"
    ...
    mac_s1=$(get_mac_avg "S1_NoAttack_Medium_noattack")
    mac_s5=$(get_mac_avg "S5_RSA_NoAttack_Medium")
    mac_s6=$(get_mac_avg "S6_ECDSA_NoAttack_Medium")
