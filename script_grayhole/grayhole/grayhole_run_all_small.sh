...
SCENARIOS=(
    ...
    "S5_NoAttack_Active_Small"
    "S6_Attack_Active_Small_8pct"
    "S6_Attack_Active_Small_15pct"
    "S6_Attack_Active_Small_30pct"
    "S6_Attack_Active_Small_40pct"
    "S6_Attack_Active_Small_50pct"
    "S6_Attack_Active_Small_60pct"
)

SIM_TIME=290  # 300s - 10s warmup
...
for scenario in "${SCENARIOS[@]}"; do
    ...
    for ((r=0; r<5; r++)); do
        ...
        opp_run -m -u Cmdenv \
          ...
          -l ../../../inet/src/INET \
          -l ../../../veins/src/veins \
          -c $scenario -r $r omnet_small.ini 2>&1 | tail -1
        echo "  ✓ Run #$r"
    done
...
METRICS_FILE="results/metriche_small.txt"
echo "================================================================" > $METRICS_FILE
echo "METRICHE COMPLETE — Small Topology — $(date)" >> $METRICS_FILE
echo "================================================================" >> $METRICS_FILE
