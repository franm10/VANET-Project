...
RESULTS_DIR="$WORK_DIR/results_parallel_${TIMESTAMP}_medium"
...
cp omnet_medium.ini "$RESULTS_DIR/omnet_medium.ini"
...
SCENARIOS=(
    "S1_NoAttack_Medium_8pct"
    "S1_NoAttack_Medium_15pct"
    "S1_NoAttack_Medium_30pct"
    "S1_NoAttack_Medium_40pct"
    "S1_NoAttack_Medium_50pct"
    "S1_NoAttack_Medium_60pct"
    ...
    "S3_NoAttack_Trust_Medium_8pct"
    "S3_NoAttack_Trust_Medium_15pct"
    "S3_NoAttack_Trust_Medium_30pct"
    "S3_NoAttack_Trust_Medium_40pct"
    "S3_NoAttack_Trust_Medium_50pct"
    "S3_NoAttack_Trust_Medium_60pct"
...
run_one() {
    ...
    opp_run "${OPP_ARGS[@]}" -c "$scenario" -r "$r" omnet_medium.ini \
...
echo "========================================================"
echo "Lancio simulazioni GRAYHOLE MEDIUM con max $MAX_JOBS thread."
...
if [ -f "$RESULTS_DIR/.sim_error" ]; then
    ...
    echo "Calcolo metriche Grayhole Medium in corso..."
    echo ""

    METRICS_FILE="$RESULTS_DIR/metriche_grayhole_medium.txt"

    echo "================================================================" > "$METRICS_FILE"
    echo "METRICHE COMPLETE — Grayhole Attack — Medium Topology" >> "$METRICS_FILE"
...
fi # <-- Questo è il fatidico "fi" mancante che chiude l'if aperto alla riga 173!
